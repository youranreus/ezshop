 ...
 * @date 2022-08-07
 */
import {Card, Col, Row, Skeleton, SideSheet, Space, Tag, Divider} from '@douyinfe/semi-ui';
            ...
            <div className="detail" style={{maxWidth: "580px", margin: "0 auto"}}>
                ...
                <div className="meta">
                    ...
                    <Row>
                        <Col span={24}>
                            <Space wrap={true}>
                                {itemData.labels.slice(1, -1).split('#').map((tag, index) => {
                                    return <Tag key={index} color={"green"} type={"light"}>{tag}</Tag>
                                })}
                            </Space>
                        </Col>
                    </Row>
